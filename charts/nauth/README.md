...
| nats.accountReconciliationInterval | string | `"5m"` | How often Accounts are periodically reconciled and how long successful NATS Account state validation remains fresh. |
