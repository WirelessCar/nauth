...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *SystemReference) DeepCopyInto(out *SystemReference) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new SystemReference.
func (in *SystemReference) DeepCopy() *SystemReference {
	if in == nil {
		return nil
	}
	out := new(SystemReference)
